module.exports = nativeDescription: "español (ES)", englishDescription: "Spanish (Spain)", translation:
  ...
  ozaria_home:
    ...
    heading_subtitle: "Una aventura de programación para estudiantes y tu solución llave en mano para enseñar Ciencias de la Computación."
    item_list_p: "¡Prueba el Capítulo 1 Gratis Hoy!"
    engaging_heading_corner: "Una solución para involucrar a los estudiantes y apoyar a los profesores"
    engaging_row1_h2: "Implementación Fácil"
    engaging_row1_p: "Incluso sin experiencia en programación, puedes enseñar un plan de estudios completo de Ciencias de la Computación con Ozaria. Nuestros planes de lecciones listos para usar y el panel intuitivo te proporcionarán las herramientas que necesitas para estar listo para enseñar desde el primer día."
    engaging_row2_h2: "Juego Inmersivo"
    engaging_row2_p: "Los estudiantes están inmersos en un juego de aventuras en el que su conocimiento de Ciencias de la Computación avanza con la trama. En este entorno de aprendizaje atractivo, los estudiantes desarrollan habilidades del mundo real a través del poder del juego."
    engaging_row3_h2: "Plan de Estudios Alineado con Estándares"
    engaging_row3_p: "Ozaria cumple con los estándares CSTA e ISTE, lo que te permite enseñar con confianza mientras tus estudiantes dominan conceptos fundamentales de Ciencias de la Computación, desarrollan habilidades de pensamiento computacional y comprenden la relevancia de la Ciencia de la Computación en su vida diaria."
    pd_blurb: "Aprende las habilidades para enseñar eficazmente la informática con nuestro curso de autoaprendizaje acreditado por CSTA. Gana hasta 40 horas de crédito en cualquier momento y desde cualquier dispositivo."
    back_cta_1_a: "Prueba el Capítulo 1 Gratis"
    speech_bubble_testimonial_1_blockquote: "Una vez más, tu equipo ha logrado alcanzar el Santo Grial de la Educación y el Entretenimiento. En mi opinión, como educador de secundaria con 26 años de experiencia, no hay ningún recurso más atractivo para enseñar programación."
    core_curriculum_header: "Plan de Estudios Fundamental de Ciencias de la Computación"
    core_curriculum_p: "Hemos desarrollado nuestro modelo de instrucción basado en teorías probadas y extensa evidencia sobre cómo los estudiantes aprenden mejor."
    core_curriculum_carousel_item1_header: "Establecer Conexiones"
    core_curriculum_carousel_item1_p: "Al comienzo de cada módulo, utiliza nuestras diapositivas de lecciones llave en mano para ayudar a tus estudiantes a establecer la conexión entre nuevos conceptos de Ciencias de la Computación y ejemplos relevantes de su vida diaria."
    core_curriculum_carousel_item2_header: "Construir su Propio Significado"
    core_curriculum_carousel_item2_p: "Luego, guía a tus estudiantes en la construcción de una comprensión más profunda de los nuevos conceptos a través de actividades desenchufadas y de discusión que están integradas en nuestros planes de lecciones."
    core_curriculum_carousel_item3_header: "Aprender Nuevos Conceptos"
    core_curriculum_carousel_item3_p: "En la tercera etapa del ciclo de aprendizaje, tus estudiantes aprenderán nuevos conceptos a través de un diálogo expositivo entre personajes de la historia de Ozaria. La narración, los gráficos y las animaciones hacen que la absorción de nueva información sea aún más accesible y divertida."
    core_curriculum_carousel_item4_header: "Aplicar Nuevos Conocimientos"
    core_curriculum_carousel_item4_p: "A continuación, tus estudiantes pondrán en práctica lo que han aprendido escribiendo código real en Python o JavaScript para resolver una variedad de desafíos en niveles de juego estructurados. Las pistas incorporadas ayudan a los estudiantes a identificar y solucionar errores, lo que aumenta su confianza en la programación."
    core_curriculum_carousel_item5_header: "Proyecto Sumativo"
    core_curriculum_carousel_item5_p: "Al final de cada capítulo, tus estudiantes serán desafiados a mostrar sus nuevas habilidades y expresar su creatividad a través de proyectos sumativos en los que construirán sus propios juegos, historias y más."
    core_curriculum_scope_sequence: "Ver el Alcance y Secuencia"
    core_curriculum_sample_lesson_slides: "Ver Diapositivas de Lecciones de Muestra"
    global_community_header: "Únete a Nuestra Comunidad Global"
    
    global_community_row1_p: "Aprendices"
    global_community_row2_p: "Líneas de Código"
    global_community_row3_p: "Profesores"
    global_community_row4_p: "Países"
    admin_dashboard_header: "Paneles de Control Integral para Profesores y Administradores"
    admin_dashboard_p: "Diseñado con la retroalimentación de nuestra comunidad de más de 140,000 educadores, Ozaria aborda los desafíos de enseñar Ciencias de la Computación proporcionando herramientas y recursos que funcionan."
    admin_dashboard_row1_p: "El intuitivo Panel de Control del Profesor proporciona acceso a planes de lecciones para estudiantes, guías de ritmo, estrategias de aprendizaje a distancia y otros recursos para satisfacer tus necesidades."
    admin_dashboard_row2_p: "La página de Seguimiento de Progreso te permite monitorear el progreso de los estudiantes de manera continua, obtener información valiosa sobre su desempeño e identificar de inmediato si se necesitan intervenciones."
    admin_dashboard_row3_a: "Solicitar un Presupuesto"
    acodus_awards_a: "Prueba el Capítulo 1 Gratis"
    speech_bubble_testimonial_2_blockquote: "Es el sitio de programación más accesible que he visto hasta ahora. Aprecio la historia que acompaña a Ozaria, ya que se alinea con una misión con la que mis estudiantes pueden empatizar. Sinceramente, me encanta. De hecho, me encontré jugando durante mucho más tiempo de lo que me gustaría admitir el fin de semana pasado."
    shareable_resources_header: "Recursos Compartibles"
    shareable_resources_p: "Comparte los recursos a continuación con profesores, administradores y otros involucrados en llevar la Ciencia de la Computación a tu escuela o expandir las ofertas ya existentes."
    shareable_resources_a: "Descargar Folleto"
    back_cta_2_a: "Prueba el Capítulo 1 Gratis"
    faq_header: "Preguntas Frecuentes"
    faq_row1_header: "¿Cómo está relacionado Ozaria con CodeCombat?"
    faq_row1_p: "Ozaria es la evolución centrada en el aula de CodeCombat, uno de los juegos de programación más populares de la historia. Construimos Ozaria basándonos en las ideas obtenidas al enseñar Python y JavaScript a más de 20 millones de aprendices. Ozaria incorpora nuevos modelos pedagógicos, una narrativa inmersiva basada en la historia y fue diseñado para ser implementado en aulas, tanto en entornos de aprendizaje presenciales como a distancia."
    faq_row2_header: "¿Para qué edades o grados es apropiado Ozaria?"
    faq_row2_p: "Ozaria está alineado con los estándares de Ciencias de la Computación de la CSTA y la ISTE para la escuela secundaria, pero ha sido practicado y disfrutado por estudiantes que van desde la primaria hasta la preparatoria."
    faq_row3_header: "¿Cuánto cuesta acceder a todas las unidades y recursos disponibles?"
    faq_row3_p_part1: "Personalizamos soluciones para escuelas y distritos y trabajamos contigo para comprender tu caso de uso, contexto y presupuesto. "
    faq_row3_p_part2: "para obtener más detalles. También proporcionamos una "
    faq_row3_p_part3: "guía de recursos de financiamiento"
    faq_row3_p_part4: " para programas de Ciencias de la Computación en escuelas y distritos."
    faq_row4_header: "¿Ozaria incluye aprendizaje basado en proyectos?"
    faq_row4_p: "Sí. Ozaria incorpora Proyectos Capstone compartibles al final de cada capítulo, donde los estudiantes crean sus propios juegos. Estos proyectos sirven como evaluaciones sumativas y son excelentes formas para que los estudiantes se expresen y demuestren sus aprendizajes a compañeros, amigos y familiares."
    faq_row5_header: "¿Puedo utilizar Ozaria como el plan de estudios principal de mi clase?"
    faq_row5_p: "¡Absolutamente! Ozaria tiene todo lo que necesitas para llevar a cabo una clase completa de Ciencias de la Computación, incluso si no tienes experiencia en Ciencias de la Computación. Desde planes de lecciones y guías de soluciones hasta rúbricas de proyectos y alineación de estándares incorporada, todo está aquí."
    faq_row6_p_part1: "Si tienes alguna otra pregunta, por favor "
    see_faq_prefix: "Consulta más"
    see_faq_link: "preguntas frecuentes en nuestro centro de ayuda"
    see_faq_suffix: "."
    
    summary: "Ozaria es un programa de informática, un juego de aventuras y una historia de fantasía en la que los estudiantes dominan la magia perdida de la programación para salvar su mundo."
    value_prop1_h1: "Historia Épica. Juego Inmersivo."
    value_prop1_h2: "Inspira una conexión más profunda con el aprendizaje."
    value_prop1_p: "En Ozaria, los estudiantes se encuentran inmersos en un nuevo mundo donde dominan conceptos fundamentales de informática para avanzar en el juego. La narrativa en desarrollo crea una poderosa experiencia de aprendizaje centrada en el estudiante, donde la inversión de cada estudiante en la historia de Ozaria se asemeja a la inversión que están haciendo en su propio viaje de aprendizaje."
    value_prop2_h1: "Descubre al Héroe Dentro de Cada Estudiante."
    value_prop2_h2: "Desarrolla habilidades reales a través del juego."
    value_prop2_p: "Los conceptos y habilidades se introducen a través de una progresión de contenido cuidadosamente diseñada que incluye niveles de juego, diálogos de personajes instructivos, escenas y más. Los estudiantes aprenden a escribir en Python o JavaScript, resuelven problemas utilizando el pensamiento computacional, demuestran comprensión a través de evaluaciones formativas y aplican lo que aprenden creando sus propios proyectos."
    value_prop3_h1: "Comienza Tu Viaje Gratis"
    value_prop3_p: "Enseña a través de la aventura con contenido gratuito que cubre conceptos introductorios de informática, además de acceso a guías de implementación y planes de lecciones."
    projects_inspire_heading: "Proyectos que Inspiran. Recursos que Empoderan."
    student_creativity: "Libera la Creatividad del Estudiante"
    student_creativity_paragraph: "Al final de cada unidad, los estudiantes aplican lo que han aprendido creando proyectos, desde juegos hasta historias de aventuras interactivas y más. Con metas estructuradas pero permitiendo una ideación ilimitada, los estudiantes construyen un portafolio de trabajo compartible y jugable que muestra su identidad creativa."
    teach_with_support: "Enseña con Apoyo"
    teach_with_support_paragraph: "Ozaria está diseñado para educadores. Cada unidad en el plan de estudios tiene un plan de lecciones que detalla los objetivos de aprendizaje, las concepciones erróneas comunes de los estudiantes, los términos clave y los estándares CSTA. Además, un completo panel de control del profesor ayuda a los maestros a seguir el progreso de los estudiantes y revisar el código de los estudiantes."
    request_demo: "Solicitar una Demostración"
    im_an_educator: "Soy un Educador"
    im_a_student: "Soy un Estudiante"
    global_title: "Únete a Nuestra Comunidad Global de Aprendices y Educadores"
    global_subtitle1: "Aprendices"
    global_subtitle2: "Líneas de Código"
    global_subtitle3: "Profesores"
    global_subtitle4: "Países"
    sign_up: "Regístrate"
    individual_account_warning: "Has iniciado sesión como __name__, que es una cuenta individual. Ozaria es solo para cuentas de maestros y estudiantes; ¿necesitas actualizar tu cuenta?"
    learner_number: "12 Millones"
    code_line_number: "1 Billón"
    dei_initiatives: "¿Qué iniciativas tiene Ozaria para garantizar la diversidad, equidad e inclusión en el juego?"
    dei_initiatives_blurb: "Ozaria se dedica a promover la diversidad, equidad e inclusión (DEI) dentro del juego. A través de una representación diversa de personajes, oportunidades equitativas y un entorno inclusivo, Ozaria abraza las diferencias y fomenta una experiencia acogedora para jugadores de todos los orígenes y habilidades. Explora nuestra __deipage__ para obtener más información sobre nuestro compromiso e iniciativas hacia la DEI en Ozaria."
    dei_page: "página de DEI"
    ozaria_efficacy: "¿Cómo mide y demuestra Ozaria su eficacia en la mejora de los resultados de aprendizaje en el aula?"
    ozaria_efficacy_blurb: "Priorizamos la eficacia a través de prácticas basadas en evidencia y evaluación. Nuestra __efficacypage__ ofrece estadísticas detalladas, citas reales de maestros y estudios de caso convincentes que demuestran el impacto transformador de Ozaria. Al crear experiencias de aprendizaje significativas y emplear prácticas basadas en evidencia, diseñamos contenido que ofrece los resultados que más importan a maestros y estudiantes."
    efficacy_page: "página de eficacia"
    social_learning: "¿Promueve Ozaria el aprendizaje social y emocional (SEL)?"
    social_learning_blurb: "¡Sí! Ozaria integra activamente el aprendizaje social y emocional (SEL) en su plan de estudios. A través de actividades gamificadas, los estudiantes desarrollan habilidades esenciales como la toma de decisiones, la autoconciencia, la autogestión, la conciencia social, las habilidades para establecer relaciones y la toma de decisiones responsables. Puedes obtener más información sobre nuestra filosofía en nuestra __selpage__."
...
#    title_cn_home: "CodeCombat|Python, Javascript"
    ...
    built_for_teachers_subblurb2: "Los aprendices construyen laberintos y utilizan manejo básico de entrada para programar sus propios juegos que pueden compartir con amigos y familiares."
    built_for_teachers_subtitle3: "Desarrollo Web"
    built_for_teachers_subblurb3: "Usando HTML, CSS y jQuery, los aprendices flexionan sus músculos creativos para programar sus propias páginas web con una URL personalizada para compartirla con sus compañeros."
    century_skills_title: "Habilidades del siglo XXI"
    century_skills_blurb1: "Los estudiantes no solo mejoran a su héroe, sino que también se mejoran a sí mismos"
    century_skills_quote1: "Te equivocas... entonces piensas en todas las posibles formas de solucionarlo y lo intentas de nuevo. No habría llegado aquí sin esforzarme."
    century_skills_subtitle1: "Pensamiento Crítico"
    century_skills_subblurb1: "Con rompecabezas de programación que están naturalmente estructurados en niveles cada vez más desafiantes, el juego de programación de CodeCombat asegura que los niños practiquen constantemente el pensamiento crítico."
    ...
    century_skills_quote3: "Si quedaba atrapado en un nivel, trabajaba con las personas a mi alrededor hasta que todos pudiéramos resolverlo."
    century_skills_subtitle3: "Colaboración"
    century_skills_subblurb3: "A lo largo del juego, hay oportunidades para que los estudiantes colaboren cuando se quedan atascados y trabajen juntos utilizando nuestra guía de programación en parejas."
    century_skills_quote4: "Siempre he tenido aspiraciones de diseñar videojuegos y aprender a programar... esto me está dando un buen punto de partida."
    century_skills_quote4_author: "Joey, 10º grado"
    century_skills_subtitle4: "Comunicación"
    century_skills_subblurb4: "La programación requiere que los niños practiquen nuevas formas de comunicación, incluida la comunicación con la computadora misma y la transmisión de sus ideas utilizando el código más eficiente."
    classroom_in_box_title: "Nos Esforzamos Por:"
    classroom_in_box_blurb1: "Involucrar a cada estudiante para que crean que la programación es para ellos."
    classroom_in_box_blurb2: "Empoderar a cualquier educador para sentirse seguro al enseñar programación."
    classroom_in_box_blurb3: "Inspirar a todos los líderes escolares a crear un programa de informática de clase mundial."
    classroom_in_box_blurb4: "" # solo para koudashijie.com
    ...
    creativity_rigor_blurb1: "Los estudiantes escriben en Python y JavaScript reales mientras juegan juegos que fomentan la prueba y error, el pensamiento crítico y la creatividad. Luego, los estudiantes aplican las habilidades de programación que han aprendido desarrollando sus propios juegos y sitios web en cursos basados en proyectos."
    creativity_rigor_subtitle2: "Alcanza a los estudiantes a su nivel"
    creativity_rigor_blurb2: "Cada nivel de CodeCombat se estructura en función de millones de puntos de datos y se optimiza para adaptarse a cada aprendiz. Los niveles de práctica y las pistas ayudan a los estudiantes cuando se quedan atrapados, y los niveles de desafío evalúan el aprendizaje de los estudiantes a lo largo del juego."
    creativity_rigor_subtitle3: "Diseñado para todos los maestros, independientemente de su experiencia"
    creativity_rigor_blurb3: "El plan de estudios de CodeCombat, autocontenido y alineado con los estándares, hace que enseñar informática sea posible para todos. CodeCombat proporciona a los maestros la capacitación, los recursos de instrucción y el apoyo dedicado para sentirse seguros y exitosos en el aula."
    featured_partners_title1: "Destacado en"
    featured_partners_title2: "Premios y Colaboraciones"
    featured_partners_blurb1: "Socio de Clever"
    featured_partners_blurb2: "Mejor Herramienta de Creatividad para Estudiantes"
    featured_partners_blurb3: "Elección Principal para el Aprendizaje"
    featured_partners_blurb4: "Socio Oficial de Code.org"
    featured_partners_blurb5: "Miembro Oficial de CSforAll"
    featured_partners_blurb6: "Socio de Actividades de la Hora del Código"
    for_leaders_title: "Para Líderes Escolares"
    for_leaders_blurb: "Un Programa Integral de Informática Alineado con Estándares"
    for_leaders_subtitle1: "Implementación Sencilla"
    for_leaders_subblurb1: "Un programa basado en la web que no requiere soporte de TI. Comience en menos de 5 minutos utilizando Google o Clever Single Sign-On (SSO)."
    for_leaders_subtitle2: "Currículo Completo de Programación"
    for_leaders_subblurb2: "Un currículo alineado con estándares con recursos de instrucción y desarrollo profesional para permitir que cualquier maestro enseñe informática."
    for_leaders_subtitle3: "Diversos Casos de Uso"
    for_leaders_subblurb3: "Ya sea que desee construir una electiva de programación de escuela secundaria, una vía de CTE o una clase de Principios de Ciencias de la Computación de AP, CodeCombat está diseñado para satisfacer sus necesidades."
    for_leaders_subtitle4: "Habilidades del Mundo Real"
    for_leaders_subblurb4: "Los estudiantes desarrollan determinación y desarrollan una mentalidad de crecimiento a través de desafíos de programación que los preparan para los más de 500,000 empleos de computación abiertos."
    for_teachers_title: "Para Maestros"
    for_teachers_blurb: "Herramientas para Desbloquear el Potencial del Estudiante"
    for_teachers_subtitle1: "Aprendizaje Basado en Proyectos"
    for_teachers_subblurb1: "Promueva la creatividad, la resolución de problemas y la confianza en cursos basados en proyectos donde los estudiantes desarrollan sus propios juegos y páginas web."
    for_teachers_subtitle2: "Panel de Control del Maestro"
    for_teachers_subblurb2: "Vea datos sobre el progreso de los estudiantes, descubra recursos de currículo y acceda a soporte en tiempo real para empoderar el aprendizaje de los estudiantes."
    for_teachers_subtitle3: "Evaluaciones Integradas"
    for_teachers_subblurb3: "Personalice la instrucción y asegúrese de que los estudiantes comprendan conceptos clave con evaluaciones formativas y sumativas."
    for_teachers_subtitle4: "Diferenciación Automática"
    for_teachers_subblurb4: "Involucre a todos los estudiantes en un aula diversa con niveles de práctica que se adaptan a las necesidades de aprendizaje de cada estudiante."
    game_based_blurb: "CodeCombat es un programa de informática basado en juegos donde los estudiantes escriben código real y ven cómo reaccionan sus personajes en tiempo real."
    get_started: "Empezar"
    global_title: "Únete a Nuestra Comunidad Global de Aprendices y Educadores"
    global_subtitle1: "Aprendices"
    global_subtitle2: "Líneas de Código"
    ...
    quotes_quote1: "Nombre cualquier programa en línea, lo he probado. Ninguno se compara con CodeCombat y Ozaria. Cualquier maestro que quiera que sus estudiantes aprendan a programar... comience aquí."
    quotes_quote2: "Me sorprendió lo fácil e intuitivo que CodeCombat hace que sea aprender informática. Las calificaciones en el examen de AP fueron mucho más altas de lo que esperaba y creo que CodeCombat es la razón por la que esto sucedió."
    quotes_quote3: "CodeCombat ha sido el más beneficioso para enseñar a mis estudiantes capacidades de codificación de la vida real. Mi esposo es ingeniero de software y ha probado todos mis programas. Puso esto como su primera opción."
    quotes_quote4: "La retroalimentación... ha sido tan positiva que estamos estructurando una clase de informática en torno a CodeCombat. El programa realmente involucra a los estudiantes con una plataforma de estilo de juego que es entretenida e instructiva al mismo tiempo. Sigan con el buen trabajo, CodeCombat."
    quotes_quote5: "A pesar de que la clase comienza todos los sábados a las 7 de la mañana, ¡mi hijo está tan emocionado que se despierta antes que yo! CodeCombat crea un camino para que mi hijo avance en sus habilidades de codificación."
    ...
    slogan_power_of_play: "Aprende a Programar a Través del Poder del Juego"
    teach_cs1_free: "Enseña CS1 Gratis"
    teachers_love_codecombat_title: "Los Maestros Aman CodeCombat"
    teachers_love_codecombat_blurb1: "Informan que a sus estudiantes les gusta usar CodeCombat para aprender a programar."
    teachers_love_codecombat_blurb2: "Recomendarían CodeCombat a otros maestros de informática."
    teachers_love_codecombat_blurb3: "Afirman que CodeCombat les ayuda a apoyar las habilidades de resolución de problemas de los estudiantes."
    teachers_love_codecombat_subblurb: "En asociación con McREL International, líder en orientación basada en investigaciones y evaluaciones de tecnología educativa."
    top_banner_blurb: "Padres, regalen a sus hijos el don de la programación y la instrucción personalizada con nuestros maestros en vivo."
    top_banner_summer_camp: "Inscripción abierta para nuestros campamentos de verano de programación. Pregúntenos acerca de nuestras sesiones virtuales de una semana que comienzan en solo $199."
    top_banner_blurb_pd: "Ahora ofrecemos desarrollo profesional para educadores."
    top_banner_blurb_funding: "¡Nuevo! Guía de recursos de financiamiento de la Ley CARES para fondos ESSER y GEER para sus programas de informática."
    top_banner_blurb_maintenance: "¡Mejoras en camino! Mantenimiento programado: hasta 3 horas a partir de las __maintenanceStartTime__."
    top_banner_blurb_podcast: "¡NUEVO! Explora el mundo de la tecnología educativa con nuestro nuevo podcast 'Aventuras en EdTech'."
    top_banner_blurb_roblox: "¡NUEVO! CodeCombat llega a Roblox."
    top_banner_blurb_roblox_teachers: "¡NUEVO! CodeCombat se ha asociado con Roblox Education."
    top_banner_blurb_roblox_players: "¡NUEVO! Aprende a programar mientras juegas Roblox."
    top_banner_blurb_roblox_players_cta: "Únete a la lista de espera de Beta"
    top_banner_blurb_live_online_classes_parents: "¡PADRES! Haz que tu hijo programe hoy mismo con una clase de prueba gratuita."
    top_banner_blurb_live_online_classes: "Clases de programación en vivo en línea impulsadas por el juego."
    top_banner_blurb_live_online_classes_cta: "Regístrate para una clase de prueba gratuita."
    top_banner_blurb_demo_day: "Únete a nosotros para un seminario web de demostración el jueves 25 de agosto a las 4:00 pm EDT."
    top_banner_blurb_demo_day_10_20: "Únete a nosotros para una demostración espectacular de CodeCombat & Ozaria el jueves 20 de octubre a las 4:00 pm CDT."
    top_banner_blurb_hoc_2022_12_01: "¡Únete a nosotros el 1 de diciembre para nuestra Visita Guiada de la Hora del Código! Todo lo que necesitas para implementar nuestras nuevas actividades __topBannerHereLink__."
    top_banner_blurb_hoc_2022_12_01_here: "AQUÍ"
    top_banner_blurb_demo_day_2023_02_16: "¡DEMO EN VIVO! Descubre cómo puedes usar los deportes electrónicos para enseñar programación. Únete a nosotros el jueves 16 de febrero a las 2:00 pm PST."
    ...
    im_a_parent_description: "Explora nuestras clases de programación en línea en vivo"
    im_an_educator: "Soy un Educador"
    ...
    im_an_individual_description: "Juega en casa fuera de un entorno de clase"
    learn_more: "Aprende más"
    check_it_out: "¡Échale un vistazo!"
    ...
    builds_concepts_up: "Me gusta cómo CodeCombat desarrolla los conceptos. Es realmente fácil de entender y divertido de descubrir."
...
ozaria: "Ozaria"
codecombat_blurb: "Nuestro juego original de codificación. Recomendado para padres, individuos, educadores y estudiantes que desean experimentar uno de los juegos de codificación más queridos del mundo."
ozaria_blurb: "Un juego de aventuras y programa de Ciencias de la Computación donde los estudiantes dominan la magia perdida de la codificación para salvar su mundo. Recomendado para educadores y estudiantes."
ozaria_china_blurb: ""
...
explore_online_classes: "Explora Clases en Línea"
explore_pd: "Explora Desarrollo Profesional"
new_adventure_game_blurb: "Ozaria es nuestro nuevo juego de aventuras y tu solución integral para enseñar Ciencias de la Computación. Nuestras __slides__ para estudiantes y notas para maestros hacen que planificar y entregar lecciones sea más fácil y rápido."
lesson_slides: "diapositivas de lecciones"
pd_blurb: "Aprende las habilidades para enseñar eficazmente Ciencias de la Computación con nuestro curso de desarrollo profesional autodirigido y acreditado por CSTA. Gana hasta 40 horas de crédito en cualquier momento y desde cualquier dispositivo. Combina bien con Ozaria Classroom."
ai_league_blurb: "La codificación competitiva nunca ha sido tan épica con esta liga de deportes electrónicos educativos, que es tanto un simulador de batalla de IA como un motor de juegos para aprender código real."
codecombat_live_online_classes: "Clases en Vivo de CodeCombat"
learning_technology_blurb: "Nuestro juego original enseña habilidades del mundo real a través del poder del juego. El currículo escalonado construye sistemáticamente sobre las experiencias y el conocimiento de los estudiantes a medida que avanzan."
...
online_classes_blurb: "Nuestras clases de codificación en línea combinan el poder del juego y la instrucción personalizada para una experiencia que a tu hijo le encantará. Con opciones tanto privadas como grupales disponibles, esto es aprendizaje remoto que funciona."
codecombat_home_blurb: "__codecombatHome__ ofrece a tu hijo una forma divertida y atractiva de avanzar en sus habilidades de codificación. Con acceso a más de 530 niveles y características exclusivas como mascotas, artículos solo para miembros y héroes, tu hijo puede sumergirse por completo en el mundo de la codificación. Incluso pueden diseñar juegos para desafiar a sus amigos, crear sitios web y aplicaciones para compartir y crear equipos privados para competir en una clasificación grupal, todo en un entorno seguro e interactivo que fomenta el aprendizaje y la socialización."
...
for_individuals: "Para Individuos"
for_libraries: "Para Bibliotecas"
for_partners: "Para Socios"
for_partners_title: "Asociarse con CodeCombat"
for_partners_blurb: "Únete a nuestra misión de hacer que la codificación sea accesible y atractiva para todos al convertirte en un socio valioso de CodeCombat. Nuestras estructuras de asociación incluyen empresas educativas, patrocinadores de deportes electrónicos, distribuidores internacionales y socios de impacto social. Los socios tienen acceso a nuestros programas fáciles de usar, recursos de implementación y opciones de capacitación para una experiencia exitosa y placentera."
for_partners_button: "Explora las Asociaciones"
for_libraries_title: "Integración en Bibliotecas"
for_libraries_blurb: "Como un recurso digital totalmente autodirigido y autoimpulsado, CodeCombat es la mejor integración para bibliotecas que desean empoderar a sus miembros de todas las edades para aprender a codificar. Nuestra plataforma ofrece todo lo que los estudiantes necesitan para experimentar una educación de alto nivel en codificación a través de un currículo único y emocionante basado en juegos. Perfecto para estudiantes de tercer grado en adelante, hasta adultos que desean dominar conceptos de codificación a nivel universitario."
for_libraries_button: "Explora las Bibliotecas"
what_our_customers_are_saying: "Lo Que Dicen Nuestros Clientes"
game_based_learning: "Aprendizaje Basado en Juegos"
unique_approach_blurb: "Con nuestro enfoque único, los estudiantes adoptan el aprendizaje mientras juegan y escriben código desde el principio de su aventura, promoviendo el aprendizaje activo y una mentalidad de crecimiento."
text_based_coding: "Codificación Basada en Texto"
custom_code_engine_blurb: "Nuestro motor de código personalizado e intérprete está diseñado para principiantes, enseñando verdaderos lenguajes de programación como Python, JavaScript y C++ utilizando términos amigables para principiantes."
student_impact: "Impacto en los Estudiantes"
help_enjoy_learning_blurb: "Nuestros productos han ayudado a más de 20 millones de estudiantes a disfrutar del aprendizaje de Ciencias de la Computación, enseñándoles a ser estudiantes críticos, seguros y creativos. Involucramos a todos los estudiantes, independientemente de su experiencia, ayudándoles a darse cuenta de un camino hacia el éxito en Ciencias de la Computación."
global_community: "Únete a Nuestra Comunidad Global"
million: "__num__ Millones"
billion: "__num__ Mil Millones"
meta_keywords_podcast: "CodeCombat, python, javascript, Juegos de Codificación, podcast, edtech"
coco_worlds_header: "Mundos de CodeCombat"
coco_worlds_description: "Embárcate en una aventura de codificación en 3D en Roblox, donde puedes programar mascotas, jugar con amigos y desarrollar juegos mientras juegas uno. ¡Únete a la comunidad de CodeCombat y desata tu creatividad en el metaverso!"
coco_worlds_button: "Explora los Mundos de CodeCombat"
...
#    star: "CoCoStar"
    ...
    related_urls: "Links Relacionados"
...
#    faq: "FAQ"
    ...
    ozaria_teacher_dashboard: "Tablero del Maestro de Ozaria"
    ozaria_admin_dashboard: "Tablero de Administrador de Ozaria"
    codecombat_dashboard: "Tablero de CodeCombat"
    codecombat_teacher_dashboard: "Tablero del Maestro de CodeCombat"
    codecombat_admin_dashboard: "Tablero de Administrador de CodeCombat"
    professional_development: "Desarrollo Profesional"
    new: "¡Nuevo!"
    admin: "Administrador"
    api: "API"
    api_dashboard: "Tablero de API"
    funding_resources_guide: "Guía de Recursos de Financiamiento"
    partnerships: "Alianzas"
    podcast: "Nuestro Podcast"
    dashboard: "Tablero"
    products: "Productos"
    live_online_classes: "Clases en Vivo en Línea"
    codecombat_home: "CodeCombat Home"
    libraries: "Bibliotecas"
    codecombat_worlds_on_roblox: "Mundos de CodeCombat en Roblox"
    pricing: "Precios"
    help_center: "Centro de Ayuda"
    research_efficacy: "Investigación - Eficacia"
    research_impact: "Investigación - Impacto"
  ...
  new_home_faq:
    ...
    why_python: "¿Por qué deberías elegir Python?"
    why_python_blurb: "Python es tanto amigable para principiantes como utilizado por grandes corporaciones (como Google). Si tienes estudiantes más jóvenes o principiantes, te recomendamos encarecidamente Python."
    why_javascript: "¿Por qué deberías elegir JavaScript?"
    why_javascript_blurb: "JavaScript es el lenguaje de la web y se utiliza en casi todos los sitios web. Puedes preferir elegir JavaScript si también planeas estudiar desarrollo web. También hemos facilitado la transición de los estudiantes de Python al desarrollo web basado en JavaScript."
    javascript_versus_python: "La sintaxis de JavaScript es un poco más complicada para los principiantes que la de Python, así que si no puedes decidirte entre los dos, te recomendamos Python."
    how_do_i_get_started: "¿Cómo empiezo?"
    getting_started_1: "Crea tu cuenta de maestro"
    getting_started_2: "Crea una clase"
    getting_started_3: "Agrega estudiantes"
    getting_started_4: "Siéntate y observa cómo tus estudiantes se divierten aprendiendo a programar"
    main_curriculum: "¿Puedo usar CodeCombat o Ozaria como mi plan de estudios principal?"
    main_curriculum_blurb: "¡Absolutamente! Hemos dedicado tiempo a consultar con especialistas en educación para diseñar planes de estudios y materiales específicamente para profesores que utilizan CodeCombat u Ozaria sin experiencia previa en informática. Muchas escuelas están implementando CodeCombat y/o Ozaria como el plan de estudios principal de informática."
    clever_instant_login: "¿Soporta CodeCombat y Ozaria el inicio de sesión instantáneo de Clever?"
    clever_instant_login_blurb: "¡Sí! Consulta nuestra página de __clever__ para obtener más detalles sobre cómo empezar."
    clever_integration_faq: "Preguntas frecuentes sobre la integración de Clever"
    google_classroom: "¿Y qué pasa con Google Classroom?"
    google_classroom_blurb1: "¡Claro! Asegúrate de usar el inicio de sesión único de Google (SSO) para registrarte en tu cuenta de profesor. Si ya tienes una cuenta con tu correo electrónico de Google, utiliza el inicio de sesión único de Google la próxima vez para acceder. En el modal de Crear Clase, verás una opción para Vincular Google Classroom. En este momento, solo admitimos la importación de clases mediante Google Classroom."
    google_classroom_blurb2: "Nota: debes usar el inicio de sesión único de Google al menos una vez para registrarte o iniciar sesión y ver la opción de integración con Google Classroom."
    how_much_does_it_cost: "¿Cuánto cuesta acceder a todos los cursos y recursos disponibles?"
    how_much_does_it_cost_blurb: "Adaptamos soluciones para escuelas y distritos y trabajamos contigo para comprender tu caso de uso, contexto y presupuesto. ¡__contact__ para obtener más detalles! Consulta también nuestra información sobre __funding__ para obtener información sobre cómo aprovechar fuentes de financiamiento como los fondos ESSER y GEER de la Ley CARES."
    recommended_systems: "¿Hay un navegador y un sistema operativo recomendados?"
    recommended_systems_blurb: "CodeCombat y Ozaria funcionan mejor en computadoras con al menos 4 GB de RAM, en un navegador moderno como Chrome, Safari, Firefox o Edge. Las Chromebooks con 2 GB de RAM pueden tener problemas gráficos menores en cursos posteriores. Se requieren al menos 200 Kbps de ancho de banda por estudiante, aunque se recomienda 1 Mbps o más."
    other_questions: "Si tienes alguna otra pregunta, por favor __contact__."
    see_faq_prefix: "Ver más"
    see_faq_link: "preguntas frecuentes en nuestro centro de ayuda"
    see_faq_suffix: "."
